...
class AMBER():
    ...
    Forcefield object with typing rules for Amber model.
    ...
    def ff_assign(self, mol, charge=None, retryMDL=True, useMDL=True):
        ...
        AMBER force field assignment for RDkit Mol object
        ...
        lmp.assign(mol, self.work_dir, 'leaprc.protein.ff19SB')
        ...
        if result: result = self.assign_ctypes(mol, lmp.cmap_params, lmp.cmaps)
    ...
    def assign_ptypes(self, mol, atoms, atypenames, pair_coeffs):
        ...
        AMBER specific particle typing rules.
    ...
    def assign_btypes(self, mol, bonds, bond_coeffs):
        ...
        AMBER specific bond typing rules.
        ...
        for i, b in enumerate(mol.GetBonds()):
            ...
            for bond in bonds:
                it = bond[0]
                if ((bond[1] == i1 and bond[2] == i2) or 
                    (bond[1] == i2 and bond[2] == i1)):
    ...
    def assign_atypes(self, mol, angles, angle_coeffs):
        ...
        AMBER specific angle typing rules.
    ...
    def assign_dtypes(self, mol, dihedrals):
        ...
        AMBER specific dihedral typing rules.
    ...
    def assign_itypes(self, mol):
        ...
        AMBER specific improper typing rules.
    ...
    def assign_ctypes(self, mol, cmap_params, cmaps):
        """
        AMBER.assign_ctypes
        ...
        for cmap in cmaps:
            ...
            ct = cmap_params[ic][0]
            prm = cmap_params[ic][1]

            result = self.set_ctype(mol, i0, i1, i2, i3, i4, ct, prm)
            if not result:
                result_flag = False
                
        return result_flag

    def set_ctype(self, mol, a, b, c, d, e, ct, prm):

        key = '%i,%i,%i,%i,%i' % (a, b, c, d, e)
        
        ff=ff_class.CMAP_24(
            ff_type=ct,
            prm=prm,
        )
        cmap = utils.CMAP(a=a, b=b, c=c, d=d, e=e, ff=ff)
        mol.cmaps[key] = cmap
